...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo site_url('/Panel')?>" class="site_title"><!--<i class="fa fa-paw"></i>--><span><b><?php echo $company ?></b></span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo site_url('/Panel')?>" >Home <span class="fa fa-laptop"></span></a>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Data <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo site_url('/Panel/data')?>">Sample Boneka</a></li>
                      <li><a href="form_advanced.html">Daftar Buyer</a></li>
                      <li><a href="form_validation.html">Tambah Boneka</a></li>
                      <!--
    ...
    <!-- jquery 1.2.2-->
    <script src="<?php echo base_url(); ?>assets/vendors/jquery-122/jquery-1-2-2.min.js"></script>
    <!-- DROPZONE JS-->
    <script src="<?php echo base_url(); ?>assets/vendors/dropzone/dist/min/dropzone.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/vendors/dropzone/dist/min/dropzone.js"></script>
